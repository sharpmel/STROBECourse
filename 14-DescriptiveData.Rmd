...
-	EULAR(A) Provide additional information on average treatment duration for both treated and comparison cohorts  -	EULAR(B) Describe subjects who changed exposure status   
