...
-	Consider performing sensitivity analyses for differing deﬁnitions of exposure (item 12A) and outcome or different statistical models, if applicable  
...
Pocock and colleagues found that 43 out of 73 articles reporting observational studies contained subgroup analyses. The majority claimed differences across groups but only eight articles reported a formal evaluation of interaction (see item 12b).4 [@vandenbroucke2007]  

## Examples  
**Example 1**
<img align="right" src="images/17ex1.png" style="float:right" alt="Analysis of Oral Contraceptive Use, Presence of Factor V Leiden Allele, and Risk for Venous Thromboembolism">
...
**Example 2**
<img align="right" src="images/17ex2.png" style="float:right" alt="Sensitivity of the Rate Ratio for Cardiovascular Outcome to an Unmeasured Confounder">
