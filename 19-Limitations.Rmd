...
- Describe main limitations in laboratory procedures  
- Describe the main limitations of the data sources and assessment methods used and implications for the interpretation of the ﬁndings  
...
- Discuss the implications of using data that were not created or collected to answer the speciﬁc research question(s). Include discussion of misclassiﬁcation bias, unmeasured confounding, missing data, and changing eligibility over time, as they pertain to the study being reported  
...
literature, not as a stand-alone basis for inference and action. 207 
</br>
