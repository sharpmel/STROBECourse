...
<!--chapter:end:01-TitleAbstract.Rmd-->
...
<!--chapter:end:02-BackgroundRationale.Rmd-->
...
<!--chapter:end:04-StudyDesign.Rmd-->
...
<!--chapter:end:06-Participants.Rmd-->
...
<!--chapter:end:08-DataSourcesMeasurement.Rmd-->
...
<!--chapter:end:11-QuantitativeVariables.Rmd-->
...
- Methods used to   
 ...
 - Account for sampling strategy (e.g., estimator used)  
 ...
 - Clean data 
 - Combine or link data (person/individual/dataset level linkages) and an evaluation of the linkage quality
 - matching, complex sampling
...
where RR(a+b+) denotes RR among those exposed to both factors where RR(a−b−) is used as reference category (RR = 1.0). Ninety-five percent CIs were calculated as proposed by Hosmer and Lemeshow. RERI of 0 means no interaction” [@hallan2006].  
...
<!--chapter:end:12-StatisticalMethods.Rmd-->
...
<!--chapter:end:13-ParticipantResults.Rmd-->
...
<!--chapter:end:14-DescriptiveData.Rmd-->
...
<!--chapter:end:15-OutcomeData.Rmd-->
...
<!--chapter:end:16-MainResults.Rmd-->
...
<!--chapter:end:17-OtherAnalyses.Rmd-->
...
<!--chapter:end:19-Limitations.Rmd-->
...
<!--chapter:end:20-Interpretation.Rmd-->
...
<!--chapter:end:21-Generalizability.Rmd-->
...
<!--chapter:end:23-AdditionalInformation.Rmd-->
...
<!--chapter:end:26-CodeOfConduct.Rmd-->
